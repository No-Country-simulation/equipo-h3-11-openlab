        ...
        <nav className="absolute top-0 left-0 w-1/12 h-4/5 border-2 border-transparent border-r-gray-200">
            <div className="flex flex-col gap-4 p-8">
                ...
                <div className="flex flex-row gap-2">
                    ...
                    <NavLink className={({ isActive }) => isActive ? "active" : ""} to="/">{t("initiatives")}</NavLink>
                </div>
                <div className="flex flex-row gap-2">
                    <img src={wallet_icon} />
                    <NavLink className={({ isActive }) => isActive ? "active" : ""} to="/wallet">{t("wallet")}</NavLink>
                </div>
                <div className="flex flex-row gap-2">
                    <img src={market_icon} />
                    <NavLink className={({ isActive }) => isActive ? "active" : ""} to="/">{t("market")}</NavLink>
                </div>
                <div className="flex flex-row gap-2">
                    <img src={settings_icon} />
                    <NavLink className={({ isActive }) => isActive ? "active" : ""} to="/">{t("settings")}</NavLink>
                </div>
            </div>
            <div className="p-8">
                <div className="flex flex-row gap-2">
