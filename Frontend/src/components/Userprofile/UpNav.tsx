      ...
      <div className='max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4'>
        ...
        <div className='hidden w-full md:block md:w-auto' id='navbar-default'>
          <ul className='font-medium flex flex-col p-4 md:p-0 mt-4 border  rounded-lg bg-white md:flex-row md:space-x-2 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-slate-50 dark:bg-gray-800 md:dark:bg-slate-50 dark:border-gray-700'>
            <li className=' '>
              <div className='flex items-center space-x-3 bg-transparent hover:bg-blue-200 border border-blue-500 px-3 py-1 rounded-lg pt-1 mt-3 mr-8 transition-all duration-300 active:transform active:translate-y-1 trasition-all duration-500'>
              <div>
                <img src={usp} alt='udp' />
              </div>
                <div className=''>
